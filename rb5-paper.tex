...
\begin{figure*}[p]
  ...
  \begin{minipage}{.47\textwidth}
    \centering
    \hspace*{-1.2cm}
    \input{figures/map_plot_2023_02_16.pdf_tex}%/media/user/dddd092a/RB5-PAPER/HILL17/map_plot_2023_02_16.tex}
    \label{fig:prob1_6_2}
  \end{minipage}  
  \begin{minipage}{.25\textwidth}
    \centering
    \input{figures/nav_plot_2023_02_16_1.pdf_tex}%/media/user/dddd092a/RB5-PAPER/HILL17/map_plot_2023_02_16.tex}
    \vspace*{-.05cm}
    \input{figures/vec2_plot_2023_02_16_1.pdf_tex}%/media/user/dddd092a/RB5-PAPER/HILL17/map_plot_2023_02_16.tex}
    \label{fig:prob1_6_1}
  \end{minipage}
  \begin{minipage}{.26\textwidth}
    \centering
    \input{figures/nav_plot_2023_02_16_2.pdf_tex}%/media/user/dddd092a/RB5-PAPER/HILL17/map_plot_2023_02_16.tex}
    \vspace*{-.05cm}
    \input{figures/vec2_plot_2023_02_16_2.pdf_tex}%/media/user/dddd092a/RB5-PAPER/HILL17/map_plot_2023_02_16.tex}
    \label{fig:prob1_6_1}
  \end{minipage}
  \caption{}
\end{figure*}
