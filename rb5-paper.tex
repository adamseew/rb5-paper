...
\begin{figure}
 ...
 %\end{tikzpicture}
  \caption{
    ...
    the picture illustrates an experimental robotic platform that carries an RGB-D camera and low-power computing hardware to derive an exploratory coverage path on large-scale, long-term, and %in both indoors and outdoors. 
...
\begin{figure*}
  ...
  \begin{subfigure}[m]{0.33\textwidth}
    ...
    \label{fig:3-3}
  \end{subfigure}
  \caption{The autonomous long-term large-scale exploration %framework 
