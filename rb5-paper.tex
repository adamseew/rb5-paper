...
\title{RB5: A Real-Time Low-Cost Wheeled Robot for Autonomous Large-Scale Exploration}%, 3D~Reconstruction, and Mapping}
...
\section{Introduction}
\IEEEPARstart{M}{obile} robots are incresingly used in use cases involving both indoors and outdoors autonomous exploration. In such use case, the robot is required to identify all its surroundings including obstacles and point of interest by sensing the environment~\cite{mei2006energy}, with little to none human interaction. 
