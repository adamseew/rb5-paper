...
The approach section details the implementation and design choice in terms of both the software implementation for autonomous large-scale exploration and the low-cost hardware design in respectively Sec.~\ref{sec:le}~and~\ref{sec:md}.
