...
The framework then derives a path-following vector field that points to $\phi$ at any point, and guides the robot utilizing the gradient descent algorithm. This allows RB5 to, e.g., follow the covering path longer than approaches that utilize frontiers only, decreasing computational and cost requirements (see Sec.~\ref{sec:fe}).

Let the gradient of $\phi$ be defined
\begin{equation}
